...
public abstract class SupporterMethods {
	...
	public static LinkedList<String> CollectDataForProfile(Profile actprof) {
		...
		tmp.add(String.format("%.0f",allcosts));
		...
		if (actprof.getAllDistance() > 0) {
			...
			tmp.add(String.format("%.0f",distance));
		}
		
		tmp.add(String.format("%.0f",avarageOfDistance(actprof.getAllDistance(), actprof.getJourneys().size())));
	...
	public static LinkedList<String> CollectDataForActJourney(Profile actProf,
        ...
        tmp.add(String.format("%.0f",avarageOfDistance(jtmp.getAllJDistance(), jtmp.getDays().size())));
	...
	public static LinkedList<String> CollectDataForActDay(Profile actProf,
		...
		tmp.add(String.format("%.0f",dtmp.getCost()));
	...
	public static double avarageOfDistance(double a, int b){
		return a / b;
	}
}
